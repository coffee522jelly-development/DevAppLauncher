...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-hidden">
  <div class="fixed inset-0 bg-background/80 backdrop-blur-sm" onclick={onClose}></div>

  <div class="relative w-full max-w-2xl max-h-[90vh] bg-card text-card-foreground border rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
    <!-- Header -->
